module.exports = class Data1748674894530 {
    name = 'Data1748674894530'
    ...
    async up(db) {
        ...
        await db.query(`CREATE TABLE "pool_manager" ("id" character varying NOT NULL, "pool_count" integer NOT NULL, "swap_count" numeric NOT NULL, "total_volume_usd" numeric, "total_fees_usd" numeric, "pool_manager_address" text NOT NULL, "chain_id" integer NOT NULL, CONSTRAINT "PK_022054ff3c7f8000db679b0e953" PRIMARY KEY ("id"))`)
        ...
        await db.query(`CREATE TABLE "token_day_data" ("id" character varying NOT NULL, "date" TIMESTAMP WITH TIME ZONE NOT NULL, "token_id" character varying NOT NULL, "swap_count" numeric NOT NULL, "open" numeric, "high" numeric, "low" numeric, "close" numeric, "chain_id" integer NOT NULL, CONSTRAINT "PK_73fc06337215e86196b36822116" PRIMARY KEY ("id"))`)
        await db.query(`CREATE INDEX "IDX_b8950a8bc7b60231137573740e" ON "token_day_data" ("token_id") `)
        await db.query(`CREATE TABLE "token_hour_data" ("id" character varying NOT NULL, "date" TIMESTAMP WITH TIME ZONE NOT NULL, "token_id" character varying NOT NULL, "swap_count" numeric NOT NULL, "open" numeric, "high" numeric, "low" numeric, "close" numeric, "chain_id" integer NOT NULL, CONSTRAINT "PK_c05e57412a0166a5b8558d6e796" PRIMARY KEY ("id"))`)
        await db.query(`CREATE INDEX "IDX_7080974648c0d2c3baceb239c4" ON "token_hour_data" ("token_id") `)
        await db.query(`CREATE TABLE "token" ("id" character varying NOT NULL, "name" text NOT NULL, "symbol" text NOT NULL, "decimals" integer NOT NULL, "price" numeric, "pool_count" integer NOT NULL, "swap_count" numeric NOT NULL, "chain_id" integer NOT NULL, "token_address" text NOT NULL, "block_number" numeric NOT NULL, "timestamp" numeric NOT NULL, CONSTRAINT "PK_82fae97f905930df5d62a702fc9" PRIMARY KEY ("id"))`)
        ...
        await db.query(`CREATE TABLE "pool_day_data" ("id" character varying NOT NULL, "date" TIMESTAMP WITH TIME ZONE NOT NULL, "pool_id" character varying NOT NULL, "liquidity" numeric NOT NULL, "sqrt_price" numeric NOT NULL, "tick" integer NOT NULL, "volume_token0" numeric NOT NULL, "volume_token0_d" text NOT NULL, "volume_token1" numeric NOT NULL, "volume_token1_d" text NOT NULL, "volume_usd" numeric, "volume_percentage_change" numeric NOT NULL, "collected_fees_token0" numeric NOT NULL, "collected_fees_token1" numeric NOT NULL, "collected_fees_usd" numeric, "swap_count" numeric NOT NULL, "open" numeric, "high" numeric, "low" numeric, "close" numeric, "chain_id" integer NOT NULL, CONSTRAINT "PK_712b106eb8cc6842af6ca4cab80" PRIMARY KEY ("id"))`)
        await db.query(`CREATE INDEX "IDX_2f4c9e466537cf8101cbdceaea" ON "pool_day_data" ("pool_id") `)
        await db.query(`CREATE TABLE "pool_hour_data" ("id" character varying NOT NULL, "date" TIMESTAMP WITH TIME ZONE NOT NULL, "pool_id" character varying NOT NULL, "liquidity" numeric NOT NULL, "sqrt_price" numeric NOT NULL, "tick" integer NOT NULL, "volume_token0" numeric NOT NULL, "volume_token0_d" text NOT NULL, "volume_token1" numeric NOT NULL, "volume_token1_d" text NOT NULL, "volume_usd" numeric, "volume_percentage_change" numeric NOT NULL, "collected_fees_token0" numeric NOT NULL, "collected_fees_token1" numeric NOT NULL, "collected_fees_usd" numeric, "swap_count" numeric NOT NULL, "open" numeric, "high" numeric, "low" numeric, "close" numeric, "chain_id" integer NOT NULL, CONSTRAINT "PK_bd3e248a4a44a474ee2710ec329" PRIMARY KEY ("id"))`)
        await db.query(`CREATE INDEX "IDX_45e83e45011ed1000559b91726" ON "pool_hour_data" ("pool_id") `)
        await db.query(`CREATE TABLE "pool" ("id" character varying NOT NULL, "token0_id" character varying NOT NULL, "token1_id" character varying NOT NULL, "token0_decimals" integer NOT NULL, "token1_decimals" integer NOT NULL, "amount0" numeric NOT NULL, "amount0_d" text NOT NULL, "amount1" numeric NOT NULL, "amount1_d" text NOT NULL, "price0" numeric, "price1" numeric, "pool_address" text NOT NULL, "fee" integer NOT NULL, "sqrt_price_x96" numeric NOT NULL, "current_tick" integer NOT NULL, "liquidity" numeric NOT NULL, "volume_token0" numeric NOT NULL, "volume_token0_d" text NOT NULL, "volume_token1" numeric NOT NULL, "volume_token1_d" text NOT NULL, "volume_usd" numeric, "collected_fees_token0" numeric NOT NULL, "collected_fees_token1" numeric NOT NULL, "collected_fees_usd" numeric, "tvl_usd" numeric, "tick_spacing" integer NOT NULL, "batch_block_minimum_tick" integer NOT NULL, "batch_block_maximum_tick" integer NOT NULL, "swap_count" numeric NOT NULL, "chain_id" integer NOT NULL, "block_number" numeric NOT NULL, "timestamp" numeric NOT NULL, "created_at_timestamp" numeric NOT NULL, "created_at_block_number" numeric NOT NULL, CONSTRAINT "PK_db1bfe411e1516c01120b85f8fe" PRIMARY KEY ("id"))`)
        ...
        await db.query(`CREATE TABLE "position" ("id" character varying NOT NULL, "nft_id" text NOT NULL, "lower_tick" integer NOT NULL, "upper_tick" integer NOT NULL, "liquidity" numeric NOT NULL, "amount0" numeric NOT NULL, "amount0_d" text NOT NULL, "amount1" numeric NOT NULL, "amount1_d" text NOT NULL, "token0_id" character varying, "token1_id" character varying, "core_total_usd" numeric, "manager_id" character varying NOT NULL, "pool_id" character varying, "owner_id" character varying NOT NULL, "ratio" numeric NOT NULL, "chain_id" integer NOT NULL, "block_number" numeric NOT NULL, "timestamp" numeric NOT NULL, CONSTRAINT "PK_b7f483581562b4dc62ae1a5b7e2" PRIMARY KEY ("id"))`)
