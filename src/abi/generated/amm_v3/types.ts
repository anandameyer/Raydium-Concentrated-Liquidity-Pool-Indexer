import {Codec, struct, u64, u128, u32, i64, fixedArray, u8, address, i32, i128, unit, sum, u16, bool, ref} from '@subsquid/borsh'
...
export const PoolState: Codec<PoolState> = struct({
    ...
    rewardInfos: fixedArray(ref(() => RewardInfo), 3),
...
export const TickArrayState: Codec<TickArrayState> = struct({
    poolId: address,
    startTickIndex: i32,
    ticks: fixedArray(ref(() => TickState), 60),
